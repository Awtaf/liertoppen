    ...
    <form action={formAction} className="grid grid-cols-1 gap-6 lg:grid-cols-2">
      <div className="space-y-6">
        <fieldset className="rounded-2xl border border-border-light bg-white p-6">
          <legend className="px-1 text-xs font-bold tracking-wide text-slate uppercase">Avsender</legend>
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            <div>
              <label className={labelClass}>Bedrift / navn</label>
              <input name="senderName" required className={inputClass} placeholder="f.eks. Drammen Lager AS" />
            </div>
            <div>
              <label className={labelClass}>Telefon</label>
              <input name="senderTel" className={inputClass} />
            </div>
            <div className="sm:col-span-2">
              <label className={labelClass}>Adresse</label>
              <input name="senderAddr" className={inputClass} />
            </div>
            <div>
              <label className={labelClass}>Postnummer</label>
              <input name="senderZip" className={inputClass} />
            </div>
            <div>
              <label className={labelClass}>Sted</label>
              <input name="senderCity" className={inputClass} />
            </div>
            <div className="sm:col-span-2">
        ...
        <fieldset className="rounded-2xl border border-border-light bg-white p-6">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            ...
            {serviceKey === "EXPRESS" && (
              <div>
                <label className={labelClass}>Km utover sonegrense (kun hvis utenfor sone)</label>
                <input
                  name="extraKmOutsideZone"
                  type="number"
                  min={0}
                  value={extraKm}
          ...
          {price && (
            <>
              <p className="mt-2 text-sm font-medium text-navy">
                {price.zone ? price.zone.name : "Utenfor definerte soner"}
              </p>
